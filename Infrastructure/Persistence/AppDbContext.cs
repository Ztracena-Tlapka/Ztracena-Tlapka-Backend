...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<User>(e =>
        {
            ...
            e.Property(u => u.FirstName).HasColumnName("first_name").HasMaxLength(80).IsRequired();
            e.Property(u => u.LastName).HasColumnName("last_name").HasMaxLength(80).IsRequired();
            e.Property(u => u.Email).HasColumnName("email").HasMaxLength(255).IsRequired();
            e.HasIndex(u => u.Email).IsUnique();
            e.Property(u => u.PasswordHash).HasColumnName("password_hash").IsRequired();
            e.Property(u => u.Phone).HasColumnName("phone").HasMaxLength(30).IsRequired();
            e.Property(u => u.Region).HasColumnName("region").HasMaxLength(100).IsRequired();
            e.Property(u => u.District).HasColumnName("district").HasMaxLength(100).IsRequired();
            e.Property(u => u.City).HasColumnName("city").HasMaxLength(100).IsRequired();
